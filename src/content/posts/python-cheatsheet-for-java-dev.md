...
3. [模块与导入](#03--模块与导入)
4. [数据结构](#04--数据结构)
5. [Pydantic 数据模型](#05--pydantic-数据模型)
6. [FastAPI 框架](#06--fastapi-框架)
7. [数据库操作](#07--数据库操作)
8. [配置管理](#08--配置管理)
9. [AI Agent 对话](#09--ai-agent-对话)
10. [Python 生态总览](#10--python-生态总览)
11. [核心代码分层架构](#11--核心代码分层架构)
12. [async/await 协程](#12--asyncawait-协程)
13. [装饰器 vs 注解](#13--装饰器-vs-注解)
14. [GIL 全局解释器锁](#14--gil-全局解释器锁)
15. [部署：Uvicorn & Gunicorn](#15--部署uvicorn--gunicorn)
16. [注释文化 & 生态读音](#16--注释文化--生态读音)
